...
1. the sale cannot close without valid tax data
2. the XML must match the official schema exactly
3. signatures must be valid and traceable
4. connectivity failures cannot block the business permanently
